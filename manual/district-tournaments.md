...
## [11.1 District Events](https://www.frcmanual.com/2026/district-tournaments#_111-district-events)
...
_Table 11‑1 District Point Assignment_

| Category | Points |
| --- | --- |
| Qualification Round Performance | Normal distribution of points from 22 to 4 across the highest ranked team to the lowest based on an equation. See section 11.1.1 Qualification Round Performance for details. For a typically sized District event, this will result in a minimum of 4 points being awarded for Qualification round performance. For events of all sizes, a maximum of 22 points will be awarded. |
...
| Team Age | 10 points for 2026 rookie teams 5 points for 2025 rookie teams |
...
_Table 11‑2 District Team Sort Criteria_
...
### [11.1.1 Qualification Round Performance](https://www.frcmanual.com/2026/district-tournaments#_1111-qualification-round-performance)
...
– the qualification rank of the team at the event at the conclusion of Qualification MATCHES (as reported by FMS) - N – the number of FIRST Robotics Competition teams participating in the Qualification rounds at the event - Alpha (α) – a static value (1.07) used to standardize the distribution of points at events

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image069.png)
...
### [11.1.3 Playoff Performance](https://www.frcmanual.com/2026/district-tournaments#_1113-playoff-performance)
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image070.png)

_Table 11‑4 Double Elimination Points, β values_
...
### [11.1.4 Team Judged Awards](https://www.frcmanual.com/2026/district-tournaments#_1114-team-judged-awards)
...
### [11.1.5 Team Age](https://www.frcmanual.com/2026/district-tournaments#_1115-team-age)
...
### [11.1.6 Regional Participation](https://www.frcmanual.com/2026/district-tournaments#_1116-regional-participation)
...
## [11.2 District Championship Eligibility](https://www.frcmanual.com/2026/district-tournaments#_112-district-championship-eligibility)
...
- C. District Engineering Inspiration winner (qualifies to compete for the award only), and - D. District Rookie All Star winner (qualifies to compete for the award only).
...
_Table 11‑5 2026 District Championship Capacities_
...
## [11.3 District Championships with Multiple Divisions](https://www.frcmanual.com/2026/district-tournaments#_113-district-championships-with-multiple-divisions)
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image071.png)

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image072.png)
...
_Table 11‑6 District Championship division evaluation limits_
...
## [11.4 District Championship Playoffs](https://www.frcmanual.com/2026/district-tournaments#_114-district-championship-playoffs)
...
_Figure 11‑1 4-division District Championship Playoff Bracket_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image073.png)

_Figure 11‑2 2-division District Championship Playoff Bracket_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image070.png)

_Table 11‑7 District Championship 4-ALLIANCE Playoff_

_MATCH_

_schedule_

| Round | MATCH | Upper/ Lower | | | Gap (min) | Gap (min) | Next MATCH ( MATCH # ( ALLIANCE color)) | Next MATCH ( MATCH # ( ALLIANCE color)) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Round | MATCH | Upper/ Lower | Blue | Red | Blue | Red | Winner | Loser |
| 1 | 1 | Upper | B | A | | | M3 ( R ) | M4 ( R ) |
| 1 | 2 | Upper | D | C | | | M3 (B) | M4 (B) |
| 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break |
| 2 | 3 | Upper | W2 | W1 | 17m | 24m | M6 ( R ) | M5 ( R ) |
| 2 | 4 | Lower | L2 | L1 | 24m | 31m | M5 (B) | |
| 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break | 15-minute break |
...
ALLIANCE of a 2-Division District Championship Playoff tournament earns 10 points. - For a 4-Division District Championship Playoff tournament, each team on a Champion

ALLIANCE earns 20 points and each team on a Finalist

ALLIANCE receives 10 points. - If any of these

ALLIANCES has recruited a BACKUP TEAM, these points are divided amongst the teams as described in section 11.1.3 Playoff Performance. - If an ALLIANCE in a District Championship Playoff has not yet recruited a BACKUP TEAM per section 10.6.3 BACKUP TEAMS, the ALLIANCE

CAPTAIN may bring in only the highest ranked team from their division’s BACKUP POOL to join its

ALLIANCE.

## [11.5 FIRST Championship Eligibility](https://www.frcmanual.com/2026/district-tournaments#_115-first-championship-eligibility)
...
Alliance members - as many teams in District-points total order to fill the Allocated FIRST Championship slots granted per the table below.
...
_Table 11‑8 District FIRST Championship and awards allocations_
...
| --- | --- | --- | --- | --- | --- | --- |
| FIRST California | 46\* | 2 per DCMP | 4 per DCMP | 1 per DCMP | 1 per DCMP | 1 per DCMP |
| FIRST Chesapeake | 19 | 2 | 3 | 1 | 1 | 2 |
| FIRST in Michigan | 83 | 5 | 14 | 1 | 2 | 3 |
| FIRST in Texas | 28 | 2 | 5 | 2 | 2 | 2 |
| FIRST Indiana Robotics | 12 | 1 | 2 | 2 | 0 | 1 |
| FIRST Israel | 12 | 1 | 2 | 1 | 1 | 1 |
| FIRST Mid-Atlantic | 23 | 2 | 4 | 2 | 1 | 1 |
| FIRST North Carolina | 15 | 1 | 3 | 2 | 2 | 1 |
| FIRST South Carolina | 7 | 1 | 2 | 1 | 1 | 1 |
| FIRST Wisconsin | 12 | 1 | 2 | 1 | 1 | 1 |
| NE FIRST | 32 | 4 | 6 | 2 | 1 | 2 |
| Ontario | 21 | 2 | 3 | 1 | 1 | 2 |
| Pacific Northwest | 21 | 2 | 4 | 2 | 1 | 2 |
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image075.png)
