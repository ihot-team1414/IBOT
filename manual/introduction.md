---
url: "https://www.frcmanual.com/2026/introduction"
title: "FRCManual.com"
---
...
## [1.1 About FIRST®](https://www.frcmanual.com/2026/introduction\#_11-about-first)
...
Please visit [the FIRST website](http://www.firstinspires.org/) for more information about FIRST and its programs.
...
## [1.2 In Memoriam](https://www.frcmanual.com/2026/introduction\#_12-in-memoriam)
...
_Figure 1‑1 Dr. Woodie Flowers, 1943-2019_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image001.jpg)

## [1.3 FIRST® Robotics Competition](https://www.frcmanual.com/2026/introduction\#_13-first-robotics-competition)
...
In 2026, FIRST Robotics Competition is projected to reach approximately 90,000 high-school

students

representing more than 3,700 teams. Teams represent more than 30 countries and come from nearly every state in the United States.
...
## [1.4 FIRST Ethos and Core Values](https://www.frcmanual.com/2026/introduction\#_14-first-ethos-and-core-values)

### [1.4.1 Core Values](https://www.frcmanual.com/2026/introduction\#_141-core-values)
...
### [1.4.2 Gracious Professionalism®, a FIRST Credo](https://www.frcmanual.com/2026/introduction\#_142-gracious-professionalism-a-first-credo)
...
_Figure 1‑2 Dr. Woodie Flowers, Gracious Professionalism advocate and exemplar_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image002.jpg)
...
### [1.4.3 Coopertition®](https://www.frcmanual.com/2026/introduction\#_143-coopertition)
...
| Woodie Flowers Liz Calef (88) Mike Bastoni (23) Ken Patton (51, 65) Kyle Hughes (27) Bill Beatty (71) Dave Verbrugge (5110, 67) Andy Baker (3940, 45) Dave Kelso (131) Paul Copioli (3310, 217) | Rob Mainieri (812, 64, 498, 991, & 2375) Dan Green (111) Mark Breadner (188) John Novak (16, 323) Chris Fultz (234) John Larock (365) Earl Scime (2614) Fredi Lajvardi (842) Lane Matheson (932) Mark Lawrence (1816) | Eric Stokely (258, 360, 2557, & 5295) Glenn Lee (359) Gail Drake (1885) Allen Gregory (3847) Lucien Junkin (118) Matt Fagen (4253) Christine Sapio (2486) Mark Buckner (4265) Norman Morgan (2468) Francisco Guerra (4635) |
| --- | --- | --- |

## [1.5 Spirit of Volunteering](https://www.frcmanual.com/2026/introduction\#_15-spirit-of-volunteering)
...
FIRST Alumni and Graduating

Students

:

You’ve experienced firsthand the impact of FIRST in your life, the opportunities it has provided, and the excitement of participating. Your FIRST experience does not have to end after you graduate – being a volunteer or mentor gives you the opportunity to continue learning, growing, building a community, and having fun at FIRST events. Your experience as a

student

in a FIRST program is invaluable to helping ensure future

students

have an amazing experience. [There are volunteer roles for every skill \\
\\
level\\
\\
, background, and \\
...
Supervisors – Ayla DeLaat & Bryan Herbst Global FIRST Technical Advisors (

FTAs

) – James Cerar & Mark McLeod Global Head

Referees

– Aidan Browne & Jon Zawislak Global Judge Advisors – Cindy Stong & Allen Bancroft Global Lead

Robot

Inspectors

– Chuck Dickerson & Alida Mendes-MacCracken Global Lead Scorekeepers – Alex Herreid & Andrea “Duckie” Tribo Global Volunteer Coordinators – Laurie Shimizu & Sarah Plemmons

## [1.6 This Document & Its Conventions](https://www.frcmanual.com/2026/introduction\#_16-this-document-its-conventions)
...
- detail about the REBUILT playing
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image003.png)
...
Evergreen rules, or rules which are expected to go relatively unchanged from season to season, are indicated with a leading asterisk and their rule number and headline are presented in bold green text. “Relatively unchanged” means that the overall intent and presence of the rule from season to season is constant, but game specific terms may be updated as needed (e.g. changing Power Cells to

FUEL

in a rule about what COACHES may not contact during a

MATCH

). These rules also start their respective section, so their rule number is not expected to change from season to season.

All other rule headlines use bold blue text. Any disagreement between the specific language used in the rules and the colloquial language is an error, and the specific rule language is the ultimate authority. If you discover a disparity, please let us know at [customerservice@firstinspires.org](mailto:customerservice@firstinspires.org) and we will correct it.
...
transportation procedures, and award descriptions) can be found on the [FIRST Robotics Competition website](https://www.firstinspires.org/resources/library/frc/season-materials#additional-materials).

## [1.7 Translations & Other Versions](https://www.frcmanual.com/2026/introduction\#_17-translations-other-versions)

The REBUILT manual is originally and officially written in English and is occasionally translated into other languages for the benefit of FIRST Robotics Competition teams whose native language may not be English. These assets are posted on the [Translated Manuals section](https://www.firstinspires.org/resources/library/frc/season-materials#translations).

A text-based English version is provided only for use with assistive devices on the [Translated Manuals section](https://www.firstinspires.org/resources/library/frc/season-materials#translations). This document is locked for editing and has a watermark applied to indicate that it should not be copied. If you have any questions on the document, please contact the FIRST Robotics Competition Team Advocate at [frcteamadvocate@firstinspires.org](mailto:frcteamadvocate@firstinspires.org?subject=Text-based%20manual%20request).

In the event that a rule or description is modified in an alternate version of this manual, the English pdf version as published on the [Season Materials webpage](https://www.firstinspires.org/resources/library/frc/season-materials) is the commanding version.

## [1.8 Team Updates](https://www.frcmanual.com/2026/introduction\#_18-team-updates)
...
Team Updates are posted on the [Season Materials webpage](https://www.firstinspires.org/resources/library/frc/season-materials) and are generally posted before 5 pm, Eastern.
...
## [1.9 Question and Answer System](https://www.frcmanual.com/2026/introduction\#_19-question-and-answer-system)

The [Question and Answer System (Q&A)](https://frc-qa.firstinspires.org/) is a resource for clarifying the [2026 REBUILT Game Manual](https://firstfrc.blob.core.windows.net/frc2026/Manual/2026FRCGameManual.pdf), [Awards webpages](https://www.firstinspires.org/resources/library/frc/awards), [official](https://www.firstinspires.org/resources/library/frc/playing-field)

[FIELD](https://www.firstinspires.org/resources/library/frc/playing-field)

[drawings](https://www.firstinspires.org/resources/library/frc/playing-field), and/or [District and Regional Events webpage](https://www.firstinspires.org/resources/library/frc/district-regional-events) content. Teams can search for previously asked questions and responses or pose new questions. Questions can include examples for clarity or reference multiple rules to understand the relationships and differences between them.

The Q&A opens on January 14, 2026, 12:00 PM Eastern. Details on the Q&A can be found on the [Season Materials webpage](https://www.firstinspires.org/resources/library/frc/season-materials). The Q&A may result in revisions to the text in the official manuals (which are communicated using the process described in Team Updates).

The responses in the Q&A do not supersede the text in the manual, although every effort will be made to eliminate inconsistencies between the two. While responses provided in the Q&A may be used to aid discussion at each event, per section 9 Inspection & Eligibility and section 6.7 Head
...
are the ultimate authority on rules. If you have concerns about enforcement trends by volunteer authorities, please notify FIRST at [customerservice@firstinspires.org](mailto:customerservice@firstinspires.org).
...
does this specific action, is it doing what this defined term is describing?

Questions from “FRC 99999” represent content asked by key volunteers (e.g.,
...
[2 FIRST Season Overview](https://www.frcmanual.com/2026/first-season-overview)
