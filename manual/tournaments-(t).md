...
Each 2026 FIRST Robotics Competition event is played in a tournament format. Each tournament consists of 3 types of
...
## [10.1 \ \ MATCH\ \  Schedules](https://www.frcmanual.com/2026/tournaments-(t)\#_101-match-schedules)
...
_Figure 10‑1 Sample_

_MATCH_

_schedule_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image065.png)

## [10.2 \ \ MATCH\ \  Replays](https://www.frcmanual.com/2026/tournaments-(t)\#_102-match-replays)
...
FAULT impacts the outcome of an event. Once a

MATCH

replay is granted, a team may not withdraw the request for the replay.
...
D. any adjustment or delay in assignment of a score or penalty (including those made after the
...
E. a gate being left open when the

MATCH

starts,

F. mistakenly allowing a
...
## [10.3 Measurement](https://www.frcmanual.com/2026/tournaments-(t)\#_103-measurement)
...
to perform sensor calibration. Events may schedule additional measurement and calibration times. The specific time(s) that the
...
T301 \*Measurement, not practice. During the period when the
...
PERIMETER, nor interact with (e.g. score, push, pickup, etc.) SCORING ELEMENTS (or anything resembling SCORING ELEMENTS), a
...
B. Humans may touch a SCORING ELEMENT but may not practice with it (e.g. throw
...
## [10.4 Practice \ \ MATCHES](https://www.frcmanual.com/2026/tournaments-(t)\#_104-practice-matches)
...
. For Regional events, it will also be published and available online on the [FRC-Events website](https://frc-events.firstinspires.org/), except during exceptional circumstances. Practice
...
### [10.4.1 Filler Line](https://www.frcmanual.com/2026/tournaments-(t)\#_1041-filler-line)
...
## [10.5 Qualification \ \ MATCHES](https://www.frcmanual.com/2026/tournaments-(t)\#_105-qualification-matches)

### [10.5.1 Schedule](https://www.frcmanual.com/2026/tournaments-(t)\#_1051-schedule)
...
are scheduled to begin. Teams receive 1 hard copy and it is also available on the [FRC-Events website](https://frc-events.firstinspires.org/), except during exceptional circumstances. Each Qualification schedule consists of a series of rounds in which each team plays 1

MATCH

per round.

### [10.5.2 \ \ MATCH\ \  Assignment](https://www.frcmanual.com/2026/tournaments-(t)\#_1052-match-assignment)
...
scheduling algorithm, please see [Idle Loop software’s website](https://idleloop.com/matchmaker/).

At events with fewer than 24 participating teams, the criteria are similar, except #5 is changed to minimize the number of times a team swaps between the blue and red
...
### [10.5.3 Qualification Ranking](https://www.frcmanual.com/2026/tournaments-(t)\#_1053-qualification-ranking)
...
| --- | --- |
| 1st | Ranking Score |
| 2nd | Average <br>ALLIANCE<br>MATCH<br> points, not including MINOR FOULS and MAJOR FOULS |
| 3rd | Average <br>FUEL<br> scored in <br>AUTO |
| 4th | Average <br>TOWER<br> points |
| 5th | Random sorting by the <br>FMS |

## [10.6 Playoff \ \ MATCHES](https://www.frcmanual.com/2026/tournaments-(t)\#_102-match-replays)
...
### [10.6.1 \ \ ALLIANCE\ \  Selection Process](https://www.frcmanual.com/2026/tournaments-(t)\#_1061-alliance-selection-process)
...
Violation: Non-STUDENT must leave the
...
Examples that are not considered good faith efforts to quickly state a valid team selection include but are not limited to:
...
invitation or T605 violation, the emcee invites any

ALLIANCE

CAPTAINS that received a T605 violation in that round to make their selections. Each

ALLIANCE

CAPTAIN may either indicate that they are ready to make their selection (and immediately do so as determined by the

FTA

or their designee) or indicate that they are not yet ready, and they will be revisited after the next accepted invitation or T605 violation. If a team with a T605 violation extends a valid invitation and the invited team declines, they are allowed to make another selection immediately or else they are skipped and will be revisited as described above. If there are multiple

ALLIANCE

CAPTAINS that have received T605 violations, they are revisited in the same order in which they received their violations. If all remaining teams in a round have received a T605 violation, each team is revisited to either make a pick immediately or receive the next highest-ranked unselected team.
...
Lead 7 receives a T605 violation. If
...
scheduled to make the next selection goes “on the clock” and their timer begins per T605.
...
When a team has declined, the team will show with a strikethrough on the team number in the audience display.

Teams highlighted in orange (will become captain if not picked) will NOT get a strikethrough if they decline as they can still become captains.
...
### [10.6.2 Playoff \ \ MATCH\ \  Bracket](https://www.frcmanual.com/2026/tournaments-(t)\#_1062-playoff-match-bracket)
...
_tops each pairing)_

![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image066.png)
...
_Table 10‑2 Typical Playoff_

_MATCH_

_schedule_

| Round | MATCH | Upper/ Lower |  |  | Gap (min) | Gap (min) | Next <br>MATCH<br> (<br>MATCH<br> # (<br>ALLIANCE<br> color)) | Next <br>MATCH<br> (<br>MATCH<br> # (<br>ALLIANCE<br> color)) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Round | MATCH | Upper/ Lower | Blue | Red | Blue | Red | Winner | Loser |
| 1 | 1 | Upper | 8 | 1 |  |  | M7 (<br>R<br>) | M5 (<br>R<br>) |
| 1 | 2 | Upper | 5 | 4 |  |  | M7 (B) | M5 (B) |
| 1 | 3 | Upper | 7 | 2 |  |  | M8 (<br>R<br>) | M6 (<br>R<br>) |
| 1 | 4 | Upper | 6 | 3 |  |  | M8 (B) | M6 (B) |
| 2 | 5 | Lower | L2 | L1 | 0:24 | 0:33 | M10 (B) |  |
| 2 | 6 | Lower | L4 | L3 | 0:15 | 0:24 | M9 (B) |  |
| 2 | 7 | Upper | W2 | W1 | 0:42 | 0:51 | M11 (<br>R<br>) | M9 (<br>R<br>) |
| 2 | 8 | Upper | W4 | W3 | 0:33 | 0:42 | M11 (B) | M10 (<br>R<br>) |
| 3 | 9 | Lower | W6 | L7 | 0:24 | 0:15 | M12 (B) |  |
| 3 | 10 | Lower | W5 | L8 | 0:42 | 0:15 | M12 (<br>R<br>) |  |
| 6-minute break | 6-minute break | 6-minute break | 6-minute break | 6-minute break | 6-minute break | 6-minute break | 6-minute break | 6-minute break |
| 4 | 11 | Upper | W8 | W7 | 0:27 | 0:36 | M14 (<br>R<br>) | M13 (<br>R<br>) |
| 4 | 12 | Lower | W9 | W10 | 0:27 | 0:18 | M13 (B) |  |
| 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star | 15-minute awards break: Imagery, Gracious Professionalism, Team Spirit, and Rising All Star |
| 5 | 13 | Lower | W12 | L11 | 0:18 | 0:27 | M14 (B) |  |
| 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design | 15-minute awards break: Autonomous, Creativity, Quality, and Industrial Design |
| Finals | 14 |  | W13 | W11 | 0:18 | 0:48 | M15 | M15 |
| 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges | 15-minute awards break: Innovation in <br>Control<br>, Excellence in Engineering, Team Sustainability, Judges |
...
#### [10.6.2.1 Playoff \ \ MATCH\ \  ties](https://www.frcmanual.com/2026/tournaments-(t)\#_10621-playoff-match-ties)
...
_Table 10‑3 Playoff_

_MATCH_

_Tiebreaker Criteria_

| Order Sort | Criteria |
| --- | --- |
| 1st | Cumulative MAJOR FOUL points due to opponent rule violations |
| 2nd | ALLIANCE<br>AUTO<br>FUEL<br> points |
| 3rd | ALLIANCE<br>TOWER<br> points |
| 4th | MATCH<br> is replayed |

#### [10.6.2.2 Playoff Finals](https://www.frcmanual.com/2026/tournaments-(t)\#_10622-playoff-finals)
...
### [10.6.3 BACKUP TEAMS](https://www.frcmanual.com/2026/tournaments-(t)\#_1063-backup-teams)
...
#### [10.6.3.1 BACKUP TEAM Coupons](https://www.frcmanual.com/2026/tournaments-(t)\#_10631-backup-team-coupons)
...
### [T607 \*No BACKUP TEAM for replayed \ \ MATCHES\ \ .](https://www.frcmanual.com/2026/tournaments-(t)\#t607-no-backup-team-for-replayed-matches)
...
### [T609 \*BACKUP TEAMS play when called.](https://www.frcmanual.com/2026/tournaments-(t)\#t609-backup-teams-play-when-called)
...
#### [10.6.3.2 BACKUP POOL](https://www.frcmanual.com/2026/tournaments-(t)\#_10632-backup-pool)
...
Selection, the lead queuer (or their designee) polls the remaining eligible teams. In rank order, the lead queuer (or their designee) will invite remaining teams to accept or decline a position in the BACKUP POOL, i.e. the group of teams willing and able to join an
...
Selection to accept the lead queuer’s (or their designee) invitation to join the BACKUP POOL.
...
### [10.6.4 \ \ LINEUPS](https://www.frcmanual.com/2026/tournaments-(t)\#_1064-lineups)
...
#### [10.6.4.1 \ \ LINEUPS\ \  for 4-team \ \ ALLIANCES](https://www.frcmanual.com/2026/tournaments-(t)\#_10641-lineups-for-4-team-alliances)
...
member but must be a member of that team’s DRIVE TEAM. This additional representative may only serve as a DRIVE COACH.

#### [10.6.4.2 Default \ \ LINEUP](https://www.frcmanual.com/2026/tournaments-(t)\#_10642-default-lineup)
...
### [10.6.5 Pit Crews](https://www.frcmanual.com/2026/tournaments-(t)\#_1065-pit-crews)
...
### [10.6.6 Small Event Exceptions](https://www.frcmanual.com/2026/tournaments-(t)\#_1066-small-event-exceptions)
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image067.png)
...
![image](https://firstfrc.blob.core.windows.net/frc2026/Manual/HTML/2026GameManual_files/image068.png)

* * *

[9 Inspection & Eligibility (I)\\
\\
This section describes the rules governing MATCH participation. A team has participated in a MATCH if any member of their DRIVE TEAM is in the ALLIANCE AREA, with or without the ROBOT on the FIELD, at the start of the MATCH.](https://www.frcmanual.com/2026/inspection-and-eligibility-(i)) [11 District Tournaments\\
\\
Teams advance through the season depending on the events at which they compete: Regional or District. This section details how District teams advance from District qualifying events to their District Championship.](https://www.frcmanual.com/2026/district-tournaments)
...
- [10.5 Qualification MATCHES](https://www.frcmanual.com/2026/tournaments-(t)#_105-qualification-matches)
  ...
  - [10.5.2 MATCH Assignment](https://www.frcmanual.com/2026/tournaments-(t)#_1052-match-assignment)
  - [10.5.3 Qualification Ranking](https://www.frcmanual.com/2026/tournaments-(t)#_1053-qualification-ranking)
- [10.6 Playoff MATCHES](https://www.frcmanual.com/2026/tournaments-(t)#_106-playoff-matches)
  - [10.6.1 ALLIANCE Selection Process](https://www.frcmanual.com/2026/tournaments-(t)#_1061-alliance-selection-process)
  - [10.6.2 Playoff MATCH Bracket](https://www.frcmanual.com/2026/tournaments-(t)#_1062-playoff-match-bracket)
  - [10.6.3 BACKUP TEAMS](https://www.frcmanual.com/2026/tournaments-(t)#_1063-backup-teams)
  - [T607 \*No BACKUP TEAM for replayed MATCHES.](https://www.frcmanual.com/2026/tournaments-(t)#t607-no-backup-team-for-replayed-matches)
